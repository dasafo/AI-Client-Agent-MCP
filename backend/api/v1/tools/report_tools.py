...
def clean_llm_html(html_text):
    """
    Sanitizes HTML generated by LLM by removing dangerous tags and attributes.
    - Removes markdown code blocks
    - Removes dangerous tags and their content
    - Removes dangerous attributes (on*, style, formaction, srcdoc, etc)
    ...
    # Optionally: remove any <meta> or <base> self-closing tag
...
async def generate_report(
    ...
    try:
        ...
        await send_email_with_report(manager['email'], report_text, subject=f"Report {report_type}", invoices=invoices)
